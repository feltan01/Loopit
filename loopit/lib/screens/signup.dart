...
class _SignupPageState extends State<SignupPage> {
  ...
  final String baseUrl = "http://10.10.154.201:8000/api"; // Gunakan ini untuk Android Emulator
  // final String baseUrl = "http://192.168.x.x:8000/api"; // Gunakan ini untuk Perangkat Fisik (isi dengan IP lokal kamu)
