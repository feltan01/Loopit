...
class HighestQualityPage extends StatefulWidget {
  const HighestQualityPage({super.key});

  @override
  State<HighestQualityPage> createState() => _HighestQualityState();
}

class _HighestQualityState extends State<HighestQualityPage> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  final List<Map<String, dynamic>> _headerData = [
    {
      "title": "Highest Quality",
      "subtitle": "Second-Hand item with first Class quality!",
      "image": "assets/images/hq1.png"
    },
    {
      "title": "Exceptional Finds",
      "subtitle": "Only the finest selections, made to last.",
      "image": "assets/images/hq2.png"
    },
    {
      "title": "Timeless Quality",
      "subtitle": "Crafted for longevity, curated for you.",
